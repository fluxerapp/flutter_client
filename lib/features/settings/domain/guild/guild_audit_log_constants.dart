...
class GuildAuditLogConstants {
  ...
  static const Map<AuditLogActionType, IconData> _actionIconMap =
      <AuditLogActionType, IconData>{
        ...
        AuditLogActionType.channelCreate: PhosphorIconsBold.hash,
        AuditLogActionType.channelUpdate: PhosphorIconsBold.hash,
        AuditLogActionType.channelDelete: PhosphorIconsBold.hash,
        AuditLogActionType.channelOverwriteCreate: PhosphorIconsBold.hash,
        AuditLogActionType.channelOverwriteUpdate: PhosphorIconsBold.hash,
        AuditLogActionType.channelOverwriteDelete: PhosphorIconsBold.hash,
        ...
        AuditLogActionType.inviteCreate: PhosphorIconsBold.link,
        AuditLogActionType.inviteUpdate: PhosphorIconsBold.link,
        AuditLogActionType.inviteDelete: PhosphorIconsBold.link,
  ...
  static const Map<AuditLogTargetType, IconData> _targetIconMap =
      <AuditLogTargetType, IconData>{
        ...
        AuditLogTargetType.channel: PhosphorIconsBold.hash,
        AuditLogTargetType.user: PhosphorIconsFill.userGear,
        AuditLogTargetType.role: PhosphorIconsFill.tag,
        AuditLogTargetType.invite: PhosphorIconsBold.link,
