...
void appendGuildMemberModerationMenuItems({
      ...
      FluxerMenuItem(
        ...
        onPressed: () async {
          ...
          await UserProfileActionsSheet.runGuildModeration(
            ...
            action: () => UserProfileActionsSheet.updateGuildMemberNickname(
              ref: ref,
              guildId: guildId,
              userId: userId,
              nick: result.nick,
  ...
  if (capabilities.canBan) {
    items.add(
      FluxerMenuItem(
        ...
        onPressed: () async {
          close();
          final result = await BanMemberSheet.show(context, username: username);
          if (result == null) {
            return;
          }
          await UserProfileActionsSheet.runGuildModeration(
